...
class SVVTProjectTesting {
	...
	void registration () throws InterruptedException{
		...
		assertTrue(confirmation.getText().contains("Za po�etak vam preporu�ujemo da:"));
		Thread.sleep(4000);
	}
	...
	
	{
		...
		assertEquals("Uspje�no ste izmijenili postavke.", confirmation.getText());
	}
